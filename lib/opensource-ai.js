// Open Source AI Directory - Data from awesome-opensource-ai
// 932 projects across 14 categories

import fs from 'fs';
import path from 'path';

const DATA_FILE = path.join(process.cwd(), 'data', 'opensource-ai.json');
...
function loadProjects() {
  try {
    ...
    console.error('Error loading opensource-ai data:', e);
  }
  return [];
}
